...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `textBoard` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
INSERT INTO `article` VALUES (1,'2020-12-08 11:04:36','2021-02-10 08:58:21','HeyCong blog에 오신걸 환영합니다😊','안녕하세요! HeyCong blog의 운영자 김유경입니다.\r\n이 블로그는 저의 개인블로그이자 포토폴리오 작품입니다.\r\n이 곳에서 앞으로의 저의 일상과 JAVA, SQL, HTML, CSS 등 IT관련 학습내용을 공유할것입니다.\r\n아직 배우는 단계라 블로그의 디자인이나 구성이 다소 부족하지만 앞으로 공부하며 보완해나갈것입니다!\r\n항상 건강하시고 즐거운하루 보내세요 🤗❣',1,1,15,2,1),(2,'2020-12-17 19:05:22','2021-02-10 08:58:20','JAVA 출력하기','# JAVA) Hello 출력하기\r\n\r\n# JAVA 예시\r\n```java\r\npublic class Main(){\r\n    public static void main(String[] args){\r\n        System.out.println(\"Hello\");\r\n    }\r\n}\r\n```',1,3,7,0,1),(3,'2020-12-17 19:08:41','2021-02-10 08:58:20','JAVA 입력하기','# JAVA) Scanner class 이용해 입력하기\r\n\r\n# JAVA 예시\r\n```java\r\nimport java.util.Scanner;\r\n\r\npublic class Main(){\r\n    public static void main(String[] args){\r\n        Scanner sc = new Scanner(System.in);\r\n        String cmd = sc.nextLine();\r\n    }\r\n}\r\n```',1,3,1,0,0),(4,'2020-12-18 11:11:54','2021-02-10 08:58:20','오늘의 저녁 is 핏zza🍕','![](https://postfiles.pstatic.net/MjAxOTA4MTBfMTE2/MDAxNTY1MzY4MDM3MzM4.ZUitMm-j30Fnz71QdFVY8EqdFu6OhHmklz82zqVeFLgg.4zR1d0PqYpAWtW9Tu1FR28n64T59uMMurlVPKuv7p6wg.JPEG.dnjdn21/SE-a022ac35-2893-4fa9-b831-c488e4e65ab0.jpg?type=w773)\r\n오늘의 저녁은 핏짜! \r\n오늘은 내가 알바하던 청년피자에서 피자를 시켜먹었다.\r\n너무너무너무너무 맛있옹 (❁´◡`❁)',1,2,9,0,0),(5,'2020-12-22 22:45:35','2021-02-10 08:58:20','날씨가 춥군🥶','오늘은 대면수업이라 아침일찍일어나 준비하고 밖을 나갔는데 날씨 왜이렇게 추운거야😖\r\n안그래도 아침에 나가기 싫은데 추우면 더 나가기 싫엉~~\r\n근데 눈은 펑펑 내렸으면 좋겠다 ㅎㅎ❤ ',1,2,10,0,0),(6,'2020-12-22 22:45:37','2021-02-10 08:58:20','SQL 테이블 생성','# SQL) 테이블 생성하기\r\n\r\nsql 예시\r\n```sql\r\nCREATE TABLE 테이블명(\r\n    컬럼명 dataType [defult 형식],\r\n        . . .\r\n    컬럼명 dataType [defult 형식];\r\n)\r\n```',1,3,3,0,0),(7,'2020-12-22 22:45:40','2021-02-10 08:58:20','사이트맵이란?','# 사이트맵이란?\r\n- 사이트맵 파일을 만들고 각각의 포털사이트나 검색 엔진에 업로드 시켜주면 내 블로그나 홈페이지의 목차를 제공',1,3,5,0,0),(8,'2020-12-22 22:45:43','2021-02-10 08:58:20','구글 애널리틱스란?','# 구글 애널리틱스란?\r\n- 구글에서 무료로 제공하고 있는 웹 분석 서비스',1,3,2,0,0),(9,'2020-12-22 22:45:46','2021-02-10 08:58:20','웹분석이란?','# 웹분석\r\n- 웹사이트 이용 현황을 이해하고 사용자의 경험을 최적화 하기 위해 웹데이터를 측정, 수집, 분석 및 보고하는 것',1,3,9,0,0),(11,'2020-12-23 19:06:30','2021-02-10 08:58:20','마라탕탕탕🍜','오늘의 점저로 마라탕탕탕을 먹었다.\r\n4단계로 먹었더니 속이 지금 엉망😭\r\n그렇지만 포기할수 없th ㅓ~...🤪',1,2,14,0,1),(12,'2021-01-07 13:01:06','2021-02-10 08:58:19','API란?','# API (Application Programing Interface)\r\n- 응용프로그램에서 사용할 수 있도록, 운영 체제나 프로그래밍 언어가 제공하는 기능을 제어할 수 있게 만든 인터페이스\r\n\r\n   - 인터페이스 - 어떤 기계간의 장치끼리 정보를 교환하기 위한 수단이나 방법\r\n\r\n- 즉, 프로그램들이 서로 상호작용하는 것을 도와주는 매개체\r\n\r\n## API 사용이유\r\n- 구현방식을 알지 못해도 제품 도는 서비스가 서로 커뮤니케이션 할수있게 한다.\r\n\r\n- 애플리케이션 개발을 간소화하여 시간과 비용절약\r\n\r\n## API 유형\r\n- 공개 API : 누구나 쉽게 접근하여 정보를 공유하기 위해 만들어진 규격\r\n\r\n- 비공개 API : 권한이 있는 일부 사용자들에게만 정보를 제공하기 위해 만들어진 규격',1,3,3,0,0),(13,'2021-01-10 00:38:28','2021-02-10 08:58:19','youtube 영상 올리기 test','# 영상 올리기 test\r\n- 첫 공부 vlog\r\n```youtube\r\nk6dzRw-6MAQ\r\n```',1,3,6,0,0),(14,'2021-01-11 22:25:26','2021-02-10 08:58:19','코드펜 올리기 and 2개 이상의 뷰어 및 에디터 허용 test','# 글씨 색상\r\n```codepen\r\nhttps://codepen.io/ucong2222/embed/WNGgzaV?height=265&theme-id=light&default-tab=js,result\r\n```\r\n\r\n# 배경 색상\r\n```codepen\r\nhttps://codepen.io/ucong2222/embed/WNGgzVN?height=265&theme-id=light&default-tab=css,result&editable=true\r\n```\r\n\r\n# 콘솔 출력\r\n```codepen\r\nhttps://codepen.io/ucong2222/embed/JjRavme?height=265&theme-id=light&default-tab=js,result\r\n```',1,3,6,0,0),(15,'2021-01-17 19:08:27','2021-02-10 08:58:19','HTML 예시','```html\r\n<script>\r\nvar a = 10 ;\r\n</script>\r\n```',1,3,5,0,0),(16,'2021-01-20 00:29:46','2021-02-10 08:58:19','[JSP 개발일지] 유콩의 개발일지 #1','# 👀나의 첫번째 개발일지\r\n\r\n## 📕 만든기능\r\n### 메인페이지, 공지사항 게시물 리스트 페이지, 상세페이지, 글작성 페이지, 글수정 페이지 생성\r\n\r\n### ☑ 회원가입\r\n- 입력란이 한칸이라도 비어있으면 가입 불가능\r\n- 이미 회원가입 되어있는 아이디일 경우 가입 불가능\r\n- 비밀번호 1차, 2차 일치해야 가입가능\r\n\r\n### ☑ 로그인\r\n- 입력칸이 한칸이라도 비어있으면 로그인 불가능\r\n- 아이디 존재하지 않으면 로그인 불가능\r\n- 비밀번호 불일치시 로그인 불가능\r\n- 로그인 되어있으면 회원가입, 로그인 불가능\r\n\r\n### ☑ 로그아웃\r\n- 로그아웃 되있으면 로그아웃 불가능\r\n\r\n### ☑ 다중게시판 글 CRUD\r\n- 로그인 했을 경우에만 글작성, 수정, 삭제 가능\r\n- 게시글에 대한 권한이 없을경우 수정, 삭제 불가능\r\n\r\n```youtube\r\nYE9AhILNQ5g\r\n```\r\n\r\n## 📘 다음계획\r\n### ◻ 회원가입시 중복체크 ( Ajax 사용 )\r\n### ◻ 메인화면 디자인\r\n### ◻ 다양한 게시물 리스트 생성',1,3,4,0,0),(17,'2021-01-21 17:49:24','2021-02-10 08:58:19','마크다운','# 마크다운이란?\r\n- 글을 쉽게 쓸수 있도록 해주고 읽는 사람에게도 쉽게 읽힐 수 있도록 해주는 __글쓰기 도구__\r\n- README 파일이나 온라인 문서, 혹은 일반 텍스트 편집기로 문서 양식을 편집할 때 쓰인다.\r\n- 마크다운을 이용해 작성된 문서는 __쉽게 HTML 등 다른 문서형태로 변환 가능하다.__',1,3,2,0,0),(18,'2021-01-21 22:10:27','2021-02-10 08:58:19','마크다운 작성문법 1탄','# 마크다운 작성문법 1탄 ( 제목 / 목록 / 폰트 스타일 / 색상 )\r\n---\r\n## 📕 제목 ( Header )\r\n### h1 ~ h6 까지 표현 가능 : #의 개수로 표현\r\n\r\n#### 마크다운 작성시\r\n```text\r\n# h1\r\n## h2\r\n### h3\r\n#### h4\r\n##### h5\r\n###### h6\r\n```\r\n#### 마크다운 결과\r\n# h1\r\n## h2\r\n### h3\r\n#### h4\r\n##### h5\r\n###### h6\r\n---\r\n## 📕 목록\r\n- ### 순서 표기 O\r\n #### 마크다운 작성시\r\n```text\r\n1. 첫번째\r\n2. 두번째\r\n3. 세번째\r\n1. 네번째 (1이라고 썼지만 마크다운 결과는 4로 뜸!)\r\n```\r\n #### 마크다운 결과\r\n1. 첫번째\r\n2. 두번째\r\n3. 세번째\r\n1. 네번째\r\n\r\n- ### 순서 표기 X - ( - , * , + ) 세개 중 아무 기호를 써도 된다.\r\n#### 마크다운 작성시\r\n```text\r\n- 나는\r\n   - 김유경\r\n      - 천재야\r\n```\r\n#### 마크다운 결과\r\n- 나는\r\n   - 김유경\r\n      - 천재야\r\n---\r\n## 📕 폰트 스타일\r\n#### 마크다운 작성시\r\n```text\r\n__굵게__\r\n**굵게**\r\n_기울여쓰기_\r\n*기울여쓰기*\r\n___굵게기울여쓰기___\r\n***굵게기울여쓰기***\r\n~~취소선~~\r\n```\r\n#### 마크다운 결과\r\n__굵게__\r\n**굵게**\r\n_기울여쓰기_\r\n*기울여쓰기*\r\n___굵게기울여쓰기___\r\n***굵게기울여쓰기***\r\n~~취소선~~\r\n\r\n---\r\n## 📕 글 색상 \r\n#### 마크다운 작성시\r\n```text\r\n<span style=\"color:pink\">핑크 글씨</span>\r\n```\r\n#### 마크다운 결과\r\n<span style=\"color:pink\">핑크 글씨</span>\r\n',1,3,4,0,0),(19,'2021-01-27 08:51:33','2021-02-10 08:58:19','JAVA Math Class - 올림, 내림, 반올림','# JAVA Math Class 사용하기\r\n\r\n## 올림\r\n\r\n### 메소드 \r\n```c\r\ndouble ceil(double a)\r\n```\r\n- 예제코드\r\n```c\r\ndouble v1 = Math.ceil(1.3); // v1 = 2.0\r\ndouble v2 = Math.ceil(-1.3); // v2 = -1.0\r\n```\r\n\r\n## 내림\r\n\r\n### 메소드 \r\n```c\r\ndouble floor(double a)\r\n```\r\n- 예제코드\r\n```c\r\ndouble v1 = Math.floor(1.3); // v1 = 1.0\r\ndouble v2 = Math.floor(-1.3); // v2 = -2.0\r\n```\r\n\r\n## 반올림\r\n\r\n### 메소드 \r\n```c\r\nlong round(double a)\r\n```\r\n- 예제코드\r\n```c\r\ndouble v1 = Math.round(1.3); // v1 = 1\r\ndouble v2 = Math.round(-1.3); // v2 = 2\r\n```\r\n',1,3,0,0,0),(20,'2021-02-02 10:24:16','2021-02-10 08:58:18','[JSP 개발일지] 유콩의 개발일지 #2','# 👀나의 두번째 개발일지\r\n\r\n## 📙 진행한 내용 LIST \r\n\r\n- [x] 로그인 아이디 중복체크 ( AJAX )\r\n- [x] 권한에 따라 글쓰기, 수정, 삭제 화면에 보이기\r\n- [x] 회원가입 아이디 입력란 공백일때 중복체크시 오류 수정\r\n- [x] 메일 발송 테스트\r\n\r\n```youtube\r\npbdhR2TTSlo\r\n```\r\n\r\n##  📗 추후 계획 LIST \r\n- [ ] 패스워드 해쉬 암호화\r\n- [ ] 로그인 아이디 찾기\r\n- [ ] 로그인 비밀번호 찾기\r\n- [ ] 게시물 검색\r\n- [ ] 글 작성시 토스트 UI 에디터 적용\r\n- [ ] 회원정보 수정\r\n- [ ] 임시패스 워드 사용시 알림\r\n- [ ] 비밀번호 일정시간 사용시 변경권유 경고\r\n- [ ] 추천\r\n- [ ] 댓글\r\n- [ ] 내 글에 새 댓글 알림\r\n- [ ] 내 댓글에 추가 댓글 알림\r\n- [ ] 댓글멘션\r\n- [ ] 대댓글\r\n- [ ] 댓글, ajax화\r\n- [ ] 파일업로드\r\n- [ ] 회원인증\r\n- [ ] 관리자페이지\r\n- [ ] 1:1 쪽지\r\n- [ ] 신고\r\n- [ ] 게시물 블라인드\r\n- [ ] 좋아요, 싫어요\r\n\r\n## 📘 완료 LIST \r\n✔ 프레임워크 기초\r\n✔ 회원가입\r\n✔ 로그인 ( 아이디 중복체크 AJAX )\r\n✔ 로그아웃\r\n✔ 다중게시판 글 CRUD\r\n✔ 인터셉터\r\n✔ 로그인 / 로그아웃 상태에 따른 권한체크\r\n✔ 게시글 수정, 삭제 권한체크\r\n✔ 권한에 따라 글쓰기, 수정, 삭제기능 숨기기\r\n✔ 메일 발송 테스트',1,3,0,0,0),(21,'2021-02-02 10:24:21','2021-02-10 08:58:18','[JSP 개발일지] 유콩의 개발일지 #3','# 👀나의 세번째 개발일지\r\n\r\n## 📙 진행한 내용 LIST \r\n\r\n- [x] 패스워드 암호화\r\n- 회원가입, 로그인 시 브라우저단에서 패스워드 해쉬 암호화\r\n- 기존회원의 패스워드 해쉬 암호화 \r\n\r\n- [x] 로그인 아이디 찾기\r\n- 가입되어 있지 않은 회원이거나 회원정보가 불일치시 찾기 불가능\r\n\r\n- [x] 로그인 비밀번호 찾기 \r\n- 가입되어 있지 않은 회원이거나 회원정보가 불일치시 찾기 불가능\r\n- 등록된 이메일로 임시패스워드 전송\r\n- 임시패스워드로 로그인\r\n- 메일발송 실패시 임시 패스워드로 변경하는 것 취소\r\n\r\n- [x] 총게시물 출력\r\n\r\n```youtube\r\nM2QGKPNIk_c\r\n```\r\n\r\n##  📗 추후 계획 LIST \r\n- [ ] 게시물 검색\r\n- [ ] 글 작성시 토스트 UI 에디터 적용\r\n- [ ] 회원정보 수정\r\n- [ ] 임시패스 워드 사용시 알림\r\n- [ ] 비밀번호 일정시간 사용시 변경권유 경고\r\n- [ ] 추천\r\n- [ ] 댓글\r\n- [ ] 내 글에 새 댓글 알림\r\n- [ ] 내 댓글에 추가 댓글 알림\r\n- [ ] 댓글멘션\r\n- [ ] 대댓글\r\n- [ ] 댓글, ajax화\r\n- [ ] 파일업로드\r\n- [ ] 회원인증\r\n- [ ] 관리자페이지\r\n- [ ] 1:1 쪽지\r\n- [ ] 신고\r\n- [ ] 게시물 블라인드\r\n- [ ] 좋아요, 싫어요\r\n\r\n## 📘 완료 LIST \r\n✔ 프레임워크 기초\r\n✔ 회원가입\r\n✔ 로그인 ( 아이디 중복체크 AJAX )\r\n✔ 로그아웃\r\n✔ 다중게시판 글 CRUD\r\n✔ 인터셉터\r\n✔ 로그인 / 로그아웃 상태에 따른 권한체크\r\n✔ 게시글 수정, 삭제 권한체크\r\n✔ 권한에 따라 글쓰기, 수정, 삭제기능 숨기기\r\n✔ 메일 발송 테스트\r\n✔ 패스워드 암호화\r\n✔ 로그인 아이디 찾기\r\n✔ 로그인 비밀번호 찾기\r\n✔ 총 게시물 수 출력',1,3,0,0,0),(22,'2021-02-02 10:24:21','2021-02-10 08:58:18','[JSP 개발일지] 유콩의 개발일지 #4','# 👀나의 네번째 개발일지\r\n\r\n## 📙 진행한 내용 LIST \r\n\r\n- [x] 게시물 검색\r\n- 본문 / 제목 분류해서 검색가능 \r\n\r\n- [x] 페이지 파라미터에 따라 각 페이지에 맞는 게시물 30개만 노출\r\n\r\n- [x] 게시물 리스트 하단에 페이징 메뉴 구현 \r\n\r\n- [x] 글쓰기, 글 상세페이지에 토스트 UI 에디터 적용\r\n\r\n```youtube\r\nOzIiUliD6t4\r\n```\r\n\r\n##  📗 추후 계획 LIST \r\n- [ ] 회원정보 수정\r\n- [ ] 임시패스 워드 사용시 알림\r\n- [ ] 비밀번호 일정시간 사용시 변경권유 경고\r\n- [ ] 추천\r\n- [ ] 댓글\r\n- [ ] 내 글에 새 댓글 알림\r\n- [ ] 내 댓글에 추가 댓글 알림\r\n- [ ] 댓글멘션\r\n- [ ] 대댓글\r\n- [ ] 댓글, ajax화\r\n- [ ] 파일업로드\r\n- [ ] 회원인증\r\n- [ ] 관리자페이지\r\n- [ ] 1:1 쪽지\r\n- [ ] 신고\r\n- [ ] 게시물 블라인드\r\n- [ ] 좋아요, 싫어요\r\n\r\n## 📘 완료 LIST \r\n✔ 프레임워크 기초\r\n✔ 회원가입\r\n✔ 로그인 ( 아이디 중복체크 AJAX )\r\n✔ 로그아웃\r\n✔ 다중게시판 글 CRUD\r\n✔ 인터셉터\r\n✔ 로그인 / 로그아웃 상태에 따른 권한체크\r\n✔ 게시글 수정, 삭제 권한체크\r\n✔ 권한에 따라 글쓰기, 수정, 삭제기능 숨기기\r\n✔ 메일 발송 테스트\r\n✔ 패스워드 암호화\r\n✔ 로그인 아이디 찾기\r\n✔ 로그인 비밀번호 찾기\r\n✔ 총 게시물 수 출력\r\n✔ 게시물 검색\r\n✔ 게시물 페이징\r\n✔ 글쓰기, 상세페이지에 토스트 UI 에디터 적용',1,3,0,0,0),(23,'2021-02-02 10:24:21','2021-02-10 08:58:18','[JSP 개발일지] 유콩의 개발일지 #5','# 👀나의 다섯번째 개발일지\r\n\r\n## 📙 진행한 내용 LIST \r\n\r\n- [x] 수정게시물 토스트 에디터 적용  \r\n\r\n- [x] 회원정보수정 \r\n- 로그인 비밀번호 제외한 나머지 입력란 공백시 경고\r\n- 권한 없으면 접근 불가능\r\n\r\n```youtube\r\nWX8HEzIcrA4\r\n```\r\n\r\n##  📗 추후 계획 LIST \r\n- [ ] 임시패스 워드 사용시 알림\r\n- [ ] 비밀번호 일정시간 사용시 변경권유 경고\r\n- [ ] 추천\r\n- [ ] 댓글\r\n- [ ] 내 글에 새 댓글 알림\r\n- [ ] 내 댓글에 추가 댓글 알림\r\n- [ ] 댓글멘션\r\n- [ ] 대댓글\r\n- [ ] 댓글, ajax화\r\n- [ ] 파일업로드\r\n- [ ] 회원인증\r\n- [ ] 관리자페이지\r\n- [ ] 1:1 쪽지\r\n- [ ] 신고\r\n- [ ] 게시물 블라인드\r\n- [ ] 좋아요, 싫어요\r\n\r\n## 📘 완료 LIST \r\n✔ 프레임워크 기초\r\n✔ 회원가입\r\n✔ 로그인 ( 아이디 중복체크 AJAX )\r\n✔ 로그아웃\r\n✔ 다중게시판 글 CRUD\r\n✔ 인터셉터\r\n✔ 로그인 / 로그아웃 상태에 따른 권한체크\r\n✔ 게시글 수정, 삭제 권한체크\r\n✔ 권한에 따라 글쓰기, 수정, 삭제기능 숨기기\r\n✔ 메일 발송 테스트\r\n✔ 패스워드 암호화\r\n✔ 로그인 아이디 찾기\r\n✔ 로그인 비밀번호 찾기\r\n✔ 총 게시물 수 출력\r\n✔ 게시물 검색\r\n✔ 게시물 페이징\r\n✔ 글쓰기, 상세페이지, 수정페이지에 토스트 UI 에디터 적용\r\n✔ 회원정보수정\r\n',1,3,0,0,0),(24,'2021-02-02 10:24:21','2021-02-10 08:58:18','[JSP 개발일지] 유콩의 개발일지 #6','# 👀나의 여섯번째 개발일지\r\n\r\n## 📙 진행한 내용 LIST \r\n\r\n- [x] 임시패스워드 사용시 알림\r\n- 임시패스워드로 로그인시, 경고창 띄우고 회원정보 수정 페이지로 연결\r\n- 임시패스워드로 로그인시, 화면상단에 항상 \'비밀번호 변경해주세요.\' 알람바 표시\r\n- 비밀번호 변경시 경고창, 알람바 제거\r\n\r\n- [x] 인터셉터에 의해 로그인 필요로 저지당한 경우, 로그인 성공시 원래 목적지로 연결\r\n\r\n```youtube\r\n9rIk1vEx4bA\r\n```\r\n\r\n##  📗 추후 계획 LIST \r\n- [ ] 조회수\r\n- [ ] 비밀번호 일정시간 사용시 변경권유 경고\r\n- [ ] 비밀번호 유효성 검사\r\n- [ ] 추천\r\n- [ ] 댓글\r\n- [ ] 내 글에 새 댓글 알림\r\n- [ ] 내 댓글에 추가 댓글 알림\r\n- [ ] 댓글멘션\r\n- [ ] 대댓글\r\n- [ ] 댓글, ajax화\r\n- [ ] 파일업로드\r\n- [ ] 회원인증\r\n- [ ] 관리자페이지\r\n- [ ] 1:1 쪽지\r\n- [ ] 신고\r\n- [ ] 게시물 블라인드\r\n- [ ] 좋아요, 싫어요\r\n\r\n## 📘 완료 LIST \r\n✔ 프레임워크 기초\r\n✔ 회원가입\r\n✔ 로그인 ( 아이디 중복체크 AJAX )\r\n✔ 로그아웃\r\n✔ 다중게시판 글 CRUD\r\n✔ 인터셉터\r\n✔ 로그인 / 로그아웃 상태에 따른 권한체크\r\n✔ 게시글 수정, 삭제 권한체크\r\n✔ 권한에 따라 글쓰기, 수정, 삭제기능 숨기기\r\n✔ 메일 발송 테스트\r\n✔ 패스워드 암호화\r\n✔ 로그인 아이디 찾기\r\n✔ 로그인 비밀번호 찾기\r\n✔ 총 게시물 수 출력\r\n✔ 게시물 검색\r\n✔ 게시물 페이징\r\n✔ 글쓰기, 상세페이지, 수정페이지에 토스트 UI 에디터 적용\r\n✔ 회원정보수정\r\n✔ 임시패스워드 사용시 경고문구',1,3,0,0,0),(25,'2021-02-03 10:39:35','2021-02-10 08:58:18','[LINUX] 데몬이란?','# 데몬 (Daemon)\r\n- 멀티태스킹이 가능한 운영체제에서 사용자에 의해 제어 및 관리되지 않고, 시스템에 관련된 작업을 백그라운드에서 수행하는 프로세스',1,3,0,0,0),(26,'2021-02-09 08:52:10','2021-02-10 08:58:18','배경이미지 스크롤바 따라다니기','# 배경이미지 스크롤바 따라다니기\r\n## background attachment fixed \r\n\r\n```codepen\r\nhttps://codepen.io/ucong2222/embed/xxRVojY?height=1000&theme-id=light&default-tab=css,result&editable=true\r\n```',1,3,0,0,0);
...
-- Dump completed on 2021-02-10  9:00:23
